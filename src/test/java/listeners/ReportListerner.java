...
public class ReportListerner implements ITestListener {
    ...
    public synchronized void onTestFailure(ITestResult result) {
        if(result.getStatus() == ITestResult.FAILURE){
            ...
            String screenshotsPathWordDoc = BaseTest.takeScreenShot(failedTest);
            ...
            extentTestThread.get()
                    .fail("Test Case Failed Snapshot is below " + extentTestThread.get().addScreenCaptureFromPath(screenshotsPathWordDoc));
        }
    }
    @Override
    ...
    public void onTestSuccess(ITestResult result){
        ...
        String screenshotsPathWordDoc = BaseTest.takeScreenShot(testSucces);
